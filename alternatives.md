...
Overall throughout the alternatives.md we have surveyed deeply both non-Git and Git-based protocols and have found recurring strengths and weaknesses across decentralised social systems. The patterns discovered, allows us to seemlessly identify what our new protocol must provide and what it should avoid. This has been defined in the Requirements.md, see:
[Requirements for proposed protocol](./requirements.md)
